...
class Correo extends Validator
{
    ...
    */
    ...
    public function validarCorreo()
    {
        ...
        $sql = 'SELECT correo from empleados where correo = ?';
    ...
    public function validarCodigo()
    {
        ...
        $sql = 'SELECT correo from empleados where codigo_recu = ? and correo = ?';
    ...
    public function actualizarCodigo($codigo)
    {
        ...
        $sql = 'UPDATE empleados set codigo_recu = ? where correo = ?';
        // Enviamos los parametros
