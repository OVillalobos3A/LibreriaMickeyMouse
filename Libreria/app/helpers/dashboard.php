      ...
      <html lang="es">
        ...
        <body class="black">  
          ...
          <ul id="DropdownAdmin" class="dropdown-content">
            <li><a href="#!" class="Titulos grey-text text-darken-4">Proveedores</a></li>
            <li><a href="#!" class="Titulos grey-text text-darken-4">Marcas</a></li>
            <li><a href="#!" class="Titulos grey-text text-darken-4">Tipos de Productos</a></li>
          </ul>

          <ul id="DropdownEmpleados" class="dropdown-content">
            <li><a href="#!" class="Titulos grey-text text-darken-4">Empleados</a></li>
            <li><a href="#!" class="Titulos grey-text text-darken-4">Usuarios</a></li>
          </ul>

          <ul id="DropdownHistorial" class="dropdown-content">
            <li><a href="#!" class="Titulos grey-text text-darken-4">Facturas</a></li>
            <li><a href="#!" class="Titulos grey-text text-darken-4">Entradas</a></li>
          </ul>
          ...
          <div class="navbar-fixed">
            ...
            <nav class="navbar-transition cool-navbar z-depth-0 nv"role="navigation">
              <div class="nav-wrapper red accent-4 valing-wrapper">
                <a href="index.php" class="pad-nav brand-logo white-text Titulos pad-nav"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                width="56" height="56"
                viewBox="0 0 172 172"
                ...
                <ul class="right hide-on-med-and-down">
                  ...
                  <li><a href="productos.php" class="Subtitulos white-text">Venta<i class="right valign-wrapper"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                  width="30" height="30"
                  viewBox="0 0 172 172"
                  ...
                  <li><a href="#!" class="Subtitulos white-text">Perfil<i class="right valign-wrapper"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                  width="30" height="30"
                  viewBox="0 0 172 172"
          ...
          <ul class="sidenav" id="mobile-demo"> 
            <li><a href="#!" class="Subtitulos">Inventario<i class="left valign-wrapper"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            ...
            <li><a href="#!" class="Subtitulos">Venta<i class="left valign-wrapper"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            width="100" height="100"
            viewBox="0 0 172 172"
            ...
            <li><a href="#!" class="Subtitulos">Perfil<i class="left valign-wrapper"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            width="100" height="100"
            viewBox="0 0 172 172"
  ...
  public static function footerTemplate() {
    print('
        ...
        <footer class="page-footer black">
          <ul id="DropdownAdmin" class="dropdown-content">
            <li><a href="#!" class="Texto grey-text text-darken-4">Proveedores</a></li>
            <li><a href="#!" class="Texto grey-text text-darken-4">Marcas</a></li>
            <li><a href="#!" class="Texto grey-text text-darken-4">Tipos de Productos</a></li>
          </ul>
      
          <ul id="DropdownEmpleados" class="dropdown-content">
            <li><a href="#!" class="Texto grey-text text-darken-4">Empleados</a></li>
            <li><a href="#!" class="Texto grey-text text-darken-4">Usuarios</a></li>
          </ul>
      
          <ul id="DropdownHistorial" class="dropdown-content">
            <li><a href="#!" class="Texto grey-text text-darken-4">Facturas</a></li>
            <li><a href="#!" class="Texto grey-text text-darken-4">Entradas</a></li>
          </ul>
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                ...
                <ul>
                  <li><a href="#!" class="grey-text text-lighten-3">Inicio</a></li>
                  <li><a href="#!" class="grey-text text-lighten-3">Inventario</a></li>
                  ...
                  <li><a href="#!" class="grey-text text-lighten-3">Venta</a></li>
