    ...
    dataset.map(function (row) {
        ...
        content += `
          <tr>
              ...
              <td>
                <a href="#" onclick="openUpdateDialog(${row.id_marca})" class="btn-floating btn waves-effect waves yellow darken-3" data-tooltip="Editar"><i class="material-icons" title="Editar registro">create</i></a>
                <a href="#" onclick="openDeleteDialog(${row.id_marca})" class="btn-floating btn waves-effect waves yellow darken-3" data-tooltip="Eliminar"><i class="material-icons" title="Eliminar registro">delete</i></a>
              </td>
          </tr>
      `;
    });
