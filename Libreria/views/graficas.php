...
<div class="row container">
    ...
    <div class="col s12 m12" >
        <div class="card-panel white rad">
            <div class="row">
                <div class="s12 m6 l3 center-align">
                    <div class="card-panel amber accent-1">
                        <a class="waves-effect amber accent-4 btn-large"><i class="material-icons left" onclick="mostrarUno()">inventory_2</i>Stock</a>
                        &nbsp;
                        <a class="waves-effect amber accent-4 btn-large"><i class="material-icons left" onclick="mostrarDos()">paid</i>Ventas</a>
                        &nbsp;
                        <a class="waves-effect amber accent-4 btn-large"><i class="material-icons left" onclick="mostrarTres()">thumb_up</i>Top productos</a>
                        &nbsp;
                        <a class="waves-effect amber accent-4 btn-large"><i class="material-icons left" onclick="mostrarFull()">list_alt</i>Mostrar todo</a>
                        &nbsp;
                    </div>
                </div>
            </div>
            <div class="row" id="datos">
                <div class="row center-align" id="parte1">
                    <div class="col s12 m6 center-align">
                        <br>
                        <canvas id="chart1"></canvas>
                        <h5 class="center-align black-text">Top 5 productos con mayor stock</h5>
                    </div>
                    <div class="col s12 m6 center-align">
                        <br>
                ...
                <div class="row center-align" id="parte2">
                    <div class="col s12 m6 center-align">
                        <br>
                        <canvas id="chart7"></canvas>
                        <h5 class="center-align black-text">Top 5 productos más vendidos con frecuencia</h5>
                        <!--en este caso es la marca numero 1-->
                    </div>
                ...
                <div class="row row center-alig" id="parte3">
                    <div class="col s12 m6">
                        <br>
                    ...
                    <div class="col s12 m6 center-align">
                        ...
                        <h5 class="center-align black-text">Top fechas con mayor número de ventas</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-content">
        ...
        <form method="post" id="save-form" enctype="multipart/form-data">
            ...
            <div class="row center-align">
                ...
                <button type="submit" class="btn waves-effect yellow darken-3 tooltipped" data-tooltip="Guardar"><i
